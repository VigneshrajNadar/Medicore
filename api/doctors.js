...
// Doctors data embedded directly in the function
...
const DOCTORS_DATA = [
    ...
    },
    {
        ...
        total_reviews: 305,
        hospital_name: 'Fortis Healthcare',
        hospital_address: '88, Sector 44, Gurgaon, Haryana',
        city: 'Gurgaon',
        state: 'Haryana',
        available_days: 'Monday, Tuesday, Wednesday, Thursday, Friday',
        available_time_slots: '09:00-17:00',
    ...
    },
    {
        ...
        hospital_address: '22, Andheri West, Mumbai, Maharashtra',
        city: 'Mumbai',
        state: 'Maharashtra',
        available_days: 'Tuesday, Thursday, Saturday',
        available_time_slots: '10:00-18:00',
...
module.exports = async (req, res) => {
    ...
    if (req.method === 'GET') {
        try {
            ...
            console.log(`API called - Returning ${filteredDoctors.length} doctors`);
            res.status(200).json(filteredDoctors);
        } catch (error) {
            console.error('Error in doctors API:', error);
            res.status(500).json({ error: error.message, doctors: DOCTORS_DATA });
        }
    } else {
