    ...
    return (
      <div style={{ 
        ...
        <div style={{
          ...
          <HeartbeatLoader />
          <p style={{ marginTop: '15px', color: '#8b5cf6', fontSize: '16px', fontWeight: '600' }}>Processing Payment...</p>
        </div>
      </div>
    );
  }
            ...
            <LeftDiv style={{marginLeft:"100px"}}>
                    ...
                    <div style={{lineHeight:'36px',paddingTop:'20px',paddingLeft:'30px',paddingBottom:'10px'}}>
                        ...
                        <div style={{display:'flex'}}>   
                           ...
                           <div style={{marginLeft:'28%'}}>
                            <Link to="/pay">
                               <button  onClick={()=>One()} style={{height:'45px',width:'90px',backgroundColor:'#8b5cf6',color:'white',fontWeight:'bold',border:'none',borderRadius:'7px',marginTop:'10px'}}>Pay ₹{}</button>
                               </Link>
                           </div>
                ...
                <div style={{boxShadow: "rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px",marginTop:'20px'}}>
                    ...
                    <div style={{lineHeight:'36px',paddingTop:'20px',paddingLeft:'30px',paddingBottom:'20px'}}>
                     ...
                     <Link to="/pay">
                            <button  onClick={()=>One()}  style={{height:'42px',width:'120px',backgroundColor:'#8b5cf6',color:'white',fontWeight:'bold',border:'none',fontSize:'13px',borderRadius:'7px',marginLeft:'15px',marginTop:'10px',marginTop:'-3px'}}>VERIFY AND PAY</button>
                            </Link>
                       </div>
